...
if (($header_social_profile == array()) || ($header_social_profile == '')) {
	$header_social_profile = isset($g5plus_options['header_customize_social_profile']) && is_array($g5plus_options['header_customize_social_profile'])
		? $g5plus_options['header_customize_social_profile'] : array();
}
