	...
	<div id="g5plus-modal-search" tabindex="-1" role="dialog" aria-hidden="false" class="modal fade">
		...
		<div class="g5plus-modal-dialog g5plus-modal-search fade in">
			...
			<div class="g5plus-search-wrapper">
				<input id="search-ajax" type="search" placeholder="<?php echo __('Type at least 3 characters to search','g5plus-wolverine') ?>">
	...
	<div id="search_popup_wrapper" class="dialog">
		...
		<div class="dialog__content">
			...
			<div class="dialog-inner">
				<h2><?php _e('Enter your keyword','g5plus-wolverine'); ?></h2>
				<form  method="get" action="<?php echo esc_url(site_url()); ?>" class="search-popup-inner">
					...
					<button type="submit"><?php _e('Search','g5plus-wolverine'); ?></button>
				</form>
