...
<div id="panel-style-selector">
    <div class="panel-wrapper">
        ...
        <div class="panel-selector-header"><?php _e('Style Selector','g5plus-wolverine');?></div>
        <div class="panel-selector-body clearfix">
            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php _e('Primary Color','g5plus-wolverine'); ?></h3>
            ...
            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php _e('Layout','g5plus-wolverine'); ?></h3>
                <div class="panel-selector-row clearfix">
                    <a data-type="layout" data-value="wide" href="#" class="panel-selector-btn"><?php _e('Wide','g5plus-wolverine'); ?></a>
                    <a data-type="layout" data-value="boxed" href="#" class="panel-selector-btn"><?php _e('Boxed','g5plus-wolverine'); ?></a>
                </div>
            </section>

            <section class="panel-selector-section clearfix">
                <h3 class="panel-selector-title"><?php _e('Background','g5plus-wolverine'); ?></h3>
                <div class="panel-selector-row clearfix">
            ...
            <section class="panel-selector-section clearfix">
                <div class="panel-selector-row clearfix">
                    <a id="panel-selector-reset" href="#" class="panel-selector-btn"><?php _e('Reset','g5plus-wolverine'); ?></a>
                </div>
            </section>
        </div>
    </div>
