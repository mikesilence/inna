...
global $g5plus_options,$post;
$prefix = 'g5plus_';
$show_related_post = rwmb_meta($prefix.'show_related_post');
if ($show_related_post == -1 || $show_related_post === '') {
    $show_related_post = $g5plus_options['show_related_post'];
}
...
$posts_per_page = $g5plus_options['related_post_count'];
...
if ( $query->have_posts() ) : ?>
    <div class="post-related-wrap">
        <h2 class="post-related-title"> <span><?php _e( 'Related Posts', 'g5plus-wolverine' ); ?></span></h2>
