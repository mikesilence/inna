...
function g5plus_icon_text_settings_field($settings, $value) {
    ...
    .'<input title="'.__('Click to browse icon','g5plus-wolverine').'" style="width:20%; height:34px;" class="browse-icon button-secondary" type="button" value="'. __('Browse Icon','g5plus-wolverine') .'" >'
...
function g5plus_multi_select_settings_field_shortcode_param($settings, $value) {
    ...
    $output .= '</select><input type="checkbox" id="' . $param_name . '_select_all" >'.__('Select All','g5plus-wolverine');
...
function g5plus_add_vc_param() {
    ...
    if(function_exists('vc_add_param')){
        $add_css_animation = array(
            'type' => 'dropdown',
            'heading' => __('CSS Animation', 'g5plus-wolverine'),
            'param_name' => 'css_animation',
            'value' => array(__('No','g5plus-wolverine') => '',__('Fade In','g5plus-wolverine') => 'wpb_fadeIn',__('Fade Top to Bottom','g5plus-wolverine') => 'wpb_fadeInDown', __('Fade Bottom to Top','g5plus-wolverine') => 'wpb_fadeInUp', __('Fade Left to Right','g5plus-wolverine') => 'wpb_fadeInLeft', __('Fade Right to Left','g5plus-wolverine') => 'wpb_fadeInRight', __('Bounce In','g5plus-wolverine') => 'wpb_bounceIn',__('Bounce Top to Bottom','g5plus-wolverine') => 'wpb_bounceInDown',__('Bounce Bottom to Top','g5plus-wolverine') => 'wpb_bounceInUp', __('Bounce Left to Right','g5plus-wolverine') => 'wpb_bounceInLeft', __('Bounce Right to Left','g5plus-wolverine') => 'wpb_bounceInRight', __('Zoom In','g5plus-wolverine') => 'wpb_zoomIn', __('Flip Vertical','g5plus-wolverine') => 'wpb_flipInX',__('Flip Horizontal','g5plus-wolverine') => 'wpb_flipInY', __('Bounce','g5plus-wolverine') => 'wpb_bounce', __('Flash','g5plus-wolverine') => 'wpb_flash',__('Shake','g5plus-wolverine') => 'wpb_shake',__( 'Pulse','g5plus-wolverine') => 'wpb_pulse',__( 'Swing','g5plus-wolverine') => 'wpb_swing', __('Rubber band','g5plus-wolverine') => 'wpb_rubberBand', __('Wobble','g5plus-wolverine') => 'wpb_wobble', __('Tada','g5plus-wolverine') => 'wpb_tada'),
            'description' => __('Select type of animation if you want this element to be animated when it enters into the browsers viewport. Note: Works only in modern browsers.', 'g5plus-wolverine')
        );

        $add_duration_animation = array(
            'type' => 'textfield',
            'heading' => __('Animation Duration', 'g5plus-wolverine'),
            'param_name' => 'duration',
            'value' => '',
            'description' => __('Duration in seconds. You can use decimal points in the value. Use this field to specify the amount of time the animation plays. <em>The default value depends on the animation, leave blank to use the default.</em>', 'g5plus-wolverine'),
        ...
        $add_delay_animation = array(
            'type' => 'textfield',
            'heading' => __('Animation Delay', 'g5plus-wolverine'),
            'param_name' => 'delay',
            'value' => '',
            'description' => __('Delay in seconds. You can use decimal points in the value. Use this field to delay the animation for a few seconds, this is helpful if you want to chain different effects one after another above the fold.', 'g5plus-wolverine'),
            'dependency' => Array('element' => 'css_animation', 'value' => array('wpb_fadeIn', 'wpb_fadeInDown','wpb_fadeInUp','wpb_fadeInLeft','wpb_fadeInRight','wpb_bounceIn','wpb_bounceInDown','wpb_bounceInUp','wpb_bounceInLeft','wpb_bounceInRight','wpb_zoomIn','wpb_flipInX','wpb_flipInY','wpb_bounce', 'wpb_flash', 'wpb_shake','wpb_pulse','wpb_swing','wpb_rubberBand','wpb_wobble','wpb_tada')),
        );
        ...
        vc_add_param('vc_tta_accordion',array(
                ...
                'param_name' => 'style',
                'value' => array(
                    __( 'style 1', 'g5plus-wolverine' ) => 'style1',
                    __( 'style 2', 'g5plus-wolverine' ) => 'style2',
                    __( 'style 3', 'g5plus-wolverine' ) => 'style3',
                    __( 'style 4', 'g5plus-wolverine' ) => 'style4',
                    __( 'Classic', 'g5plus-wolverine' ) => 'classic',
                    __( 'Modern', 'g5plus-wolverine' ) => 'modern',
                    __( 'Flat', 'g5plus-wolverine' ) => 'flat',
                    __( 'Outline', 'g5plus-wolverine' ) => 'outline',
                ),
                'heading' => __( 'Style', 'g5plus-wolverine' ),
                'description' => __( 'Select accordion display style.', 'g5plus-wolverine' ),
                'weight' => 1,
            )
        );
        ...
        vc_add_param('vc_icon', array(
                'type' => 'dropdown',
                'heading' => __( 'Icon library', 'g5plus-wolverine' ),
                'value' => array(
                    __( 'Wolverine', 'g5plus-wolverine') => 'wolverine',
                    __( 'Font Awesome', 'g5plus-wolverine' ) => 'fontawesome',
                    __( 'Open Iconic', 'g5plus-wolverine' ) => 'openiconic',
                    __( 'Typicons', 'g5plus-wolverine' ) => 'typicons',
                    __( 'Entypo', 'g5plus-wolverine' ) => 'entypo',
                    __( 'Linecons', 'g5plus-wolverine' ) => 'linecons',
                ),
                'admin_label' => true,
                'weight'=>2,
                'param_name' => 'type',
                'description' => __( 'Select icon library.', 'g5plus-wolverine' ),
            )
        );
        vc_add_param('vc_icon', array(
                'type' => 'iconpicker',
                'heading' => __('Icon', 'g5plus-wolverine'),
                ...
                'weight'=>1,
                'description' => __('Select icon from library.', 'g5plus-wolverine'),
            )
        );

        vc_add_param('vc_progress_bar',array(
                'type'        => 'dropdown',
                'heading'     => __( 'Layout Style', 'g5plus-wolverine' ),
                'param_name'  => 'layout_style',
                'admin_label' => true,
                'value'       => array( __( 'style 1', 'g5plus-wolverine' ) => 'style1', __( 'style 2', 'g5plus-wolverine' ) => 'style2', __( 'style 3', 'g5plus-wolverine' ) => 'style3'),
                'description' => __( 'Select Layout Style.', 'g5plus-wolverine' ),
                'weight' => 1
            )
        );
        $settings_vc_map = array (
	        'category' => array( __( 'Content', 'g5plus-wolverine' ),__( 'Wolverine Shortcodes', 'g5plus-wolverine' ))
        );
...
function register_vc_map()
{
    $add_css_animation = array(
        ...
        'value' => array(__('No','g5plus-wolverine') => '',__('Fade In','g5plus-wolverine') => 'wpb_fadeIn',__('Fade Top to Bottom','g5plus-wolverine') => 'wpb_fadeInDown', __('Fade Bottom to Top','g5plus-wolverine') => 'wpb_fadeInUp', __('Fade Left to Right','g5plus-wolverine') => 'wpb_fadeInLeft', __('Fade Right to Left','g5plus-wolverine') => 'wpb_fadeInRight', __('Bounce In','g5plus-wolverine') => 'wpb_bounceIn',__('Bounce Top to Bottom','g5plus-wolverine') => 'wpb_bounceInDown',__('Bounce Bottom to Top','g5plus-wolverine') => 'wpb_bounceInUp', __('Bounce Left to Right','g5plus-wolverine') => 'wpb_bounceInLeft', __('Bounce Right to Left','g5plus-wolverine') => 'wpb_bounceInRight', __('Zoom In','g5plus-wolverine') => 'wpb_zoomIn', __('Flip Vertical','g5plus-wolverine') => 'wpb_flipInX',__('Flip Horizontal','g5plus-wolverine') => 'wpb_flipInY', __('Bounce','g5plus-wolverine') => 'wpb_bounce', __('Flash','g5plus-wolverine') => 'wpb_flash',__('Shake','g5plus-wolverine') => 'wpb_shake',__( 'Pulse','g5plus-wolverine') => 'wpb_pulse',__( 'Swing','g5plus-wolverine') => 'wpb_swing', __('Rubber band','g5plus-wolverine') => 'wpb_rubberBand', __('Wobble','g5plus-wolverine') => 'wpb_wobble', __('Tada','g5plus-wolverine') => 'wpb_tada'),
        'description' => __('Select type of animation if you want this element to be animated when it enters into the browsers viewport. Note: Works only in modern browsers.', 'g5plus-wolverine'),
        'group' => __('Animation Settings', 'g5plus-wolverine')
    );
	...
	$params_row=array(
		array(
			'type'       => 'dropdown',
			'heading'    => __( 'Layout', 'g5plus-wolverine' ),
			'param_name' => 'layout',
			'value'      => array(
				__( 'Full Width', 'g5plus-wolverine' )  => 'wide',
				__( 'Container', 'g5plus-wolverine' ) => 'boxed',
				__( 'Container Fluid', 'g5plus-wolverine' ) => 'container-fluid',
			),
		),
		array(
			'type' => 'checkbox',
		...
		array(
			'type' => 'textfield',
			'heading' => __('Parallax speed', 'g5plus-wolverine'),
		...
		array(
			'type' => 'dropdown',
			'heading' => __( 'Show background overlay', 'g5plus-wolverine' ),
			'param_name' => 'overlay_set',
			'description' => __( 'Hide or Show overlay on background images.', 'g5plus-wolverine' ),
			'value' => array(
				__( 'Hide, please', 'g5plus-wolverine' ) =>'hide_overlay',
				__( 'Show Overlay Color', 'g5plus-wolverine' ) =>'show_overlay_color',
				__( 'Show Overlay Image', 'g5plus-wolverine' ) =>'show_overlay_image',
			)
		),
		array(
			'type'        => 'attach_image',
			'heading'     => __( 'Image Overlay:', 'g5plus-wolverine' ),
			'param_name'  => 'overlay_image',
			'value'       => '',
			'description' => __( 'Upload image overlay.', 'g5plus-wolverine' ),
			'dependency'  => Array( 'element' => 'overlay_set', 'value' => array( 'show_overlay_image' ) ),
		),
		array(
			'type' => 'colorpicker',
			'heading' => __( 'Overlay color', 'g5plus-wolverine' ),
			'param_name' => 'overlay_color',
			'description' => __( 'Select color for background overlay.', 'g5plus-wolverine' ),
			'value' => '',
		...
		array(
			'type' => 'number',
			'class' => '',
			'heading' => __( 'Overlay opacity', 'g5plus-wolverine' ),
			'param_name' => 'overlay_opacity',
			'value' =>'50',
			'min'=>'1',
			'max'=>'100',
			'suffix'=>'%',
			'description' => __( 'Select opacity for overlay.', 'g5plus-wolverine' ),
    ...
    vc_map( array(
        'name' => __( 'Row', 'g5plus-wolverine' ),
        'base' => 'vc_row',
        'is_container' => true,
        'icon' => 'icon-wpb-row',
        'show_settings_on_create' => false,
        'category' => __( 'Content', 'g5plus-wolverine' ),
        'description' => __( 'Place content elements inside the row', 'g5plus-wolverine' ),
        'params' => $params_row,
        'js_view' => 'VcRowView'
    ) );
    vc_map( array(
        'name' => __( 'Row', 'g5plus-wolverine' ), //Inner Row
        'base' => 'vc_row_inner',
	...
	$params_section = array_merge(
        array(
            array(
                'type' => 'textfield',
                'param_name' => 'title',
                'heading' => __( 'Title', 'g5plus-wolverine' ),
                'description' => __( 'Enter section title (Note: you can leave it empty).', 'g5plus-wolverine' ),
            ),
            array(
                'type' => 'el_id',
                'param_name' => 'tab_id',
                ...
                'heading' => __( 'Section ID', 'g5plus-wolverine' ),
                'description' => __( 'Enter section ID (Note: make sure it is unique and valid according to <a href="%s" target="_blank">w3c specification</a>).', 'g5plus-wolverine' ),
            ),
            array(
                'type' => 'checkbox',
                'param_name' => 'add_icon',
                'heading' => __( 'Add icon?', 'g5plus-wolverine' ),
                'description' => __( 'Add icon next to section title.', 'g5plus-wolverine' ),
            ),
            array(
                'type' => 'dropdown',
                'param_name' => 'i_position',
                'value' => array(
                    __( 'Before title', 'g5plus-wolverine' ) => 'left',
                    __( 'After title', 'g5plus-wolverine' ) => 'right',
                ),
                'dependency' => array(
                    'element' => 'add_icon',
                    'value' => 'true',
                ),
                'heading' => __( 'Icon position', 'g5plus-wolverine' ),
                'description' => __( 'Select icon position.', 'g5plus-wolverine' ),
            ),
            array(
                'type' => 'dropdown',
                'heading' => __( 'Icon library', 'g5plus-wolverine' ),
        ...
        array(
            array(
                'type' => 'textfield',
                'heading' => __( 'Extra class name', 'g5plus-wolverine' ),
                'param_name' => 'el_class',
                'description' => __( 'If you wish to style particular content element differently, then use this field to add a class name and then refer to it in your css file.', 'g5plus-wolverine' )
            )
        )
    );
    vc_map( array(
        'name' => __( 'Section', 'g5plus-wolverine' ),
        'base' => 'vc_tta_section',
        ...
        //'content_element' => false,
        'category' => __( 'Content', 'g5plus-wolverine' ),
        'description' => __( 'Section for Tabs, Tours, Accordions.', 'g5plus-wolverine' ),
	...
	$params_piechart = array_merge(
		array(
			array(
				...
				'param_name'  => 'layout_style',
				'admin_label' => true,
				'value'       => array( __( 'Normal', 'g5plus-wolverine' ) => '', __( 'Icon', 'g5plus-wolverine' ) => 'pie_icon'),
				'description' => __( 'Select Layout Style.', 'g5plus-wolverine' ),
			),
			array(
				'type' => 'textfield',
				'heading' => __( 'Value', 'g5plus-wolverine' ),
				'param_name' => 'value',
				'description' => __( 'Enter value for graph (Note: choose range from 0 to 100).', 'g5plus-wolverine' ),
				'value' => '50',
				'admin_label' => true
			),
			array(
				'type' => 'textfield',
				'heading' => __( 'Label value', 'g5plus-wolverine' ),
				'param_name' => 'label_value',
				'description' => __( 'Enter label for pie chart (Note: leaving empty will set value from "Value" field).', 'g5plus-wolverine' ),
				'value' => ''
			),
			array(
				'type' => 'textfield',
				'heading' => __( 'Units', 'g5plus-wolverine' ),
				'param_name' => 'units',
				'description' => __( 'Enter measurement units (Example: %, px, points, etc. Note: graph value and units will be appended to graph title).', 'g5plus-wolverine' )
			),
			array(
				'type' => 'dropdown',
				'heading' => __( 'Pie chart color', 'g5plus-wolverine' ),
				'param_name' => 'color',
				'value' => getVcShared( 'colors-dashed' ) + array( __( 'Custom', 'g5plus-wolverine' ) => 'custom' ),
				'description' => __( 'Select pie chart color.', 'g5plus-wolverine' ),
				'admin_label' => true,
			...
			array(
				'type' => 'colorpicker',
				'heading' => __( 'Custom color', 'g5plus-wolverine' ),
				'param_name' => 'custom_color',
				'description' => __( 'Select custom color.', 'g5plus-wolverine' ),
				'dependency' => array(
					'element' => 'color',
					'value' => array( 'custom' )
				),
			...
			array(
				...
				'value' => array(
					...
					__( 'Entypo', 'g5plus-wolverine' ) => 'entypo',
					__( 'Linecons', 'g5plus-wolverine' ) => 'linecons',
					__( 'Image', 'g5plus-wolverine') => 'image',
				),
				'admin_label' => true,
				'param_name' => 'i_type',
				'description' => __( 'Select icon library.', 'g5plus-wolverine' ),
		...
		array(
			array(
				'type' => 'attach_image',
				'heading' => __('Upload Image Icon:', 'g5plus-wolverine'),
				'param_name' => 'i_icon_image',
				'value' => '',
				'description' => __('Upload the custom image icon.', 'g5plus-wolverine'),
				'dependency' => Array('element' => 'i_type', 'value' => array('image')),
			),
			array(
				'type' => 'colorpicker',
				'heading' => __( 'Value/Icon color', 'g5plus-wolverine' ),
				'param_name' => 'value_color',
				'description' => __( 'Select value/icon color.', 'g5plus-wolverine' ),
			),
			array(
				'type' => 'textfield',
				'heading' => __('Title', 'g5plus-wolverine'),
			...
			array(
				'type' => 'textarea',
				'heading' => __('Description', 'g5plus-wolverine'),
			...
			array(
				...
				'heading' => __( 'Extra class name', 'g5plus-wolverine' ),
				'param_name' => 'el_class',
				'description' => __( 'Style particular content element differently - add a class name and refer to it in custom CSS.', 'g5plus-wolverine' )
			),
			array(
				'type' => 'css_editor',
				'heading' => __( 'CSS box', 'g5plus-wolverine' ),
				'param_name' => 'css',
				'group' => __( 'Design Options', 'g5plus-wolverine' )
			),
		)
	);
    vc_map( array(
        'name' => __( 'Pie Chart', 'g5plus-wolverine' ),
        'base' => 'vc_pie',
        'class' => '',
        'icon' => 'icon-wpb-vc_pie',
        'category' => array( __( 'Content', 'g5plus-wolverine' ),__( 'Wolverine Shortcodes', 'g5plus-wolverine' )),
        'description' => __( 'Animated pie chart', 'g5plus-wolverine' ),
