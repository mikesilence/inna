...
$home_portfolio_flipbook = $g5plus_options['home_portfolio_flip_book_url'];
?>
<div class="other-page-flipbook">
    <?php if(isset($home_portfolio_flipbook) && $home_portfolio_flipbook!=''){ ?>
        <div class="goto-menu">
            <a href="<?php echo sprintf('%s',$home_portfolio_flipbook); ?>?action=menu" class="secondary-font"><?php echo __('Menu','g5plus-wolverine') ?></a>
        </div>
