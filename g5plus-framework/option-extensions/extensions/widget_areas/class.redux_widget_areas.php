				...
				<div id="redux-add-widget" class="widgets-holder-wrap">
				 <div class="">
				  ...
				  <div class="sidebar-name">
				   <h3><?php echo __('Create Widget Area', 'g5plus-wolverine'); ?> <span class="spinner"></span></h3>
				  </div>
				  <div class="sidebar-description">
					<form id="addWidgetAreaForm" action="" method="post">
				      <div class="widget-content">
				        <input id="redux-add-widget-input" name="redux-add-widget-input" type="text" class="regular-text" title="<?php echo __('Name', 'g5plus-wolverine'); ?>" placeholder="<?php echo __('Name', 'g5plus-wolverine'); ?>" />
				      </div>
				      <div class="widget-control-actions">
				        <div class="aligncenter">
				          <input class="addWidgetArea-button button-primary" type="submit" value="<?php echo __('Create Widget Area', 'g5plus-wolverine'); ?>" />
				        </div>
				        <br class="clear">
				      </div>
				    </form>
