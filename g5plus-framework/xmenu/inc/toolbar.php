...
function xmenu_add_toolbar_items($admin_bar) {
	...
	$admin_bar->add_node( array(
		'id'    => 'xmenutoolbar',
		'title' => '<span class="ab-icon"></span><span>' . __('XMEMU','g5plus-wolverine') . '</span>',
		'href'  => admin_url( 'themes.php?page=xmenu-settings' ),
		'meta'  => array(
			'title' => __( 'XMenu' , 'g5plus-wolverine' ),
		),
	));
	...
	$admin_bar->add_node( array(
		'id'    => 'xmenu_settings',
		'parent' => 'xmenutoolbar',
		'title' => __( 'XMENU Settings' , 'g5plus-wolverine' ),
		'href'  => admin_url( 'themes.php?page=xmenu-settings' )
	));
	...
	$admin_bar->add_node( array(
		'id'    => 'xmenu_menu_edit',
		'parent' => 'xmenutoolbar',
		'title' => __( 'Edit Menus' , 'g5plus-wolverine' ),
	...
	foreach( $menus as $menu ){
		$admin_bar->add_node( array(
			...
			'meta'  	=> array(
				'title' => __('Configure' , 'g5plus-wolverine' ) . ' '. $menu->name,
				'target' => '_blank',
				'class' => ''
			),
		));
	...
	$admin_bar->add_node( array(
		...
		'parent' => 'xmenutoolbar',
		'title' => __( 'Assign Menus' , 'g5plus-wolverine' ),
