...
if ( class_exists( 'WooCommerce' ) ) {
    ...
    if (!function_exists('g5plus_button_continue_shopping')) {
        function g5plus_button_continue_shopping () {
            ...
            ?>
            <a href="<?php echo esc_url($continue_shopping); ?>" class="continue-shopping button"><?php _e( 'Continue shopping', 'g5plus-wolverine' ); ?></a>
            <?php
        }
    }
    ...
    if (!function_exists('g5plus_custom_cart_button_text')) {
        function g5plus_custom_cart_button_text() {
            return __( 'Add to cart', 'g5plus-wolverine' );
        }
    ...
    if (!function_exists('g5plus_woocommerce_product_add_to_cart_text')) {
        function g5plus_woocommerce_product_add_to_cart_text() {
            ...
            switch ( $product_type ) {
                case 'external':
                    return __( 'Buy product', 'g5plus-wolverine' );
                    break;
                case 'grouped':
                    return __( 'View products', 'g5plus-wolverine' );
                    break;
                case 'simple':
                    return __( 'Add to cart', 'g5plus-wolverine' );
                    break;
                case 'variable':
                    return __( 'Select options', 'g5plus-wolverine' );
                    break;
                default:
                    return __( 'Read more', 'g5plus-wolverine' );
            }
        }
